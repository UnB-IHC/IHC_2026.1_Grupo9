...
**Documentação Consolidada para Exportação em PDF**
...
<!-- O título principal (h1) usa a tag de cabeçalho para o nome do projeto -->
# CheckAAA

<!-- O blockquote (>) funciona como um subtítulo de impacto, resumindo o projeto em uma linha -->
...
<!-- Estes são "Badges" (escudos). Eles dão um visual extremamente profissional e indicam o status e o contexto do repositório logo de cara -->
...
*   **Experiência do Usuário (UX) & Design:** Criação de [Personas & Jornadas Inclusivas](file:///home/giovani-coelho/Documentos/IHC_2026.1_Grupo9/docs/personas.md), [Service Blueprint & Canvas](file:///home/giovani-coelho/Documentos/IHC_2026.1_Grupo9/docs/blueprint.md), aplicação de [Design Empático](file:///home/giovani-coelho/Documentos/IHC_2026.1_Grupo9/docs/design_empatico.md) e diretrizes de interfaces usáveis.
...
*   **Avaliação, Usabilidade & Ferramentas:** Aplicação das [Heurísticas de Nielsen](file:///home/giovani-coelho/Documentos/IHC_2026.1_Grupo9/docs/heuristicas.md), condução de [Testes de Usabilidade](file:///home/giovani-coelho/Documentos/IHC_2026.1_Grupo9/docs/teste_usabilidade.md) e uso do nosso [Plugin Híbrido de Avaliação Heurística](file:///home/giovani-coelho/Documentos/IHC_2026.1_Grupo9/docs/ferramentas.md).
...
<table>
  <tr>
    ...
    <td align="center"><a href="https://github.com/joaoleless"><img style="border-radius: 50%;" src="https://github.com/joaoleless.png" width="100px;" alt=""/><br /><sub><b>João Leles</b></sub></a><br />   
...
# Checklist de Verificação de Acessibilidade: Design Empático e Pesquisa
...
## 1. Condução de Entrevistas e Etnografia
...
## 2. Elaboração do Mapa de Empatia (Inclusivo)
...
## 3. Dinâmicas e Simulações (Dinâmicas de Empatia na Equipe)
...
# Checklist de Verificação de Acessibilidade: Construção de Personas
...
## 1. Representatividade na Amostra de Pesquisa
...
## 4. Dores, Necessidades e Objetivos (Pain Points e Goals)
...
# Checklist de Verificação de Acessibilidade: Conteúdo e Redação (UX Writing)
...
## 1. Linguagem Simples e Clareza Textual (Plain Language)
...
## 4. Texto Alternativo para Imagens (Alt Text)
...
# Roteiro de Teste de Usabilidade — Castelo Forte
...
<iframe
  ...
  src="https://www.youtube.com/embed/YiTDvIgRyv0"
...
## 3. Script de Condução da Sessão
...
### 3.2 Antes de Cada Tarefa

Repetir esta transição antes de ler o cenário de cada uma das 5 tarefas (seção 4):

### 3.3 Durante a Tarefa — Intervenções Neutras
...
### 3.4 Encerramento de Cada Tarefa

!!! quote "Fala do moderador"
    *"Ok, parando por aqui. Você sente que conseguiu fazer o que eu pedi?"*

[Parar a cronometragem e registrar o resultado: **sucesso completo**, **sucesso parcial** ou **falha** — ver tabela da seção 4. Em seguida, fazer as 3 perguntas rápidas da seção 5.]

Depois das perguntas rápidas, retomar com a transição da seção 3.2 para a tarefa seguinte.

---

### 3.5 Encerramento das Tarefas → Questionário SUS
...
### 3.6 Transição para a Entrevista Final
...
## 4. Tarefas do Teste de Usabilidade
...
## 5. Perguntas Rápidas Pós-Tarefa
...
## 6. Roteiro de Entrevista Pós-Teste

Entrevista semiestruturada conduzida após a conclusão de todas as tarefas e do preenchimento do questionário SUS (seção 7). O objetivo é captar impressões gerais, achados de acessibilidade e sugestões que não aparecem nos números.
...
### 6.2 Comparação com Expectativas
...
## 8. Checklist de Observação de Acessibilidade (WCAG)
...
## 9. Planilha de Registro de Métricas
...
# 11. Plugin & Ferramenta Híbrida v3.0
...
# 12. Template do Relatório de Auditoria
...
# 13. Estudo de Caso: Castelo Forte
